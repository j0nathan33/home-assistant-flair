...
| `Room`                      | `Climate` | Temperature set points can be changed on a room by room basis. `Note:` By default, this entity is disabled if Flair system mode is set to manual.                                                                                                  |
